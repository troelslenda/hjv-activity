<?php
// $Id: Plugin.php,v 1.1 2010/04/08 20:52:19 longtailvideo Exp $
...
class Plugin
{
   ...
   * @param boolean $enable Whether a plugin is enabled or not.  Used in
   * conjunction with a Player configuration.
   ...
   * @param array $newFlashVars The new array of FlashVar objects to be
